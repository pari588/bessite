<?php
/**
 * 4-Inch Borewell Submersible Pump Image Processor
...
// Product mapping for 4-inch borewell submersibles
$products = [
    [
        'pumpID' => 40,
        'title' => '4W7BU1AU',
        'seoUri' => '4w7bu1au',
        'imageUrl' => 'https://www.crompton.co.in/cdn/shop/files/4w-png.png?v=1729769845',
        'filename' => '4w7bu1au'
    ],
    [
        'pumpID' => 41,
...
echo "=== 4-INCH BOREWELL SUBMERSIBLE PUMP IMAGE PROCESSOR ===\n\n";
...
foreach ($products as $product) {
    ...
    $tempFile = tempnam(sys_get_temp_dir(), '4inch_');
...
echo "\n=== PROCESSING COMPLETE ===\n";
echo "4-inch borewell images have been processed with transparency.\n";
