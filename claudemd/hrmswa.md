...
| Item | Value |
|------|-------|
| Phone Number ID | `1043005518890167` |
| WABA ID | `774168882413528` (NEW — hello_world only) |
| Display Number | `+91 93210 92317` |
| Verified Name | Bombay Engineering Syndicate |
| Platform Type | CLOUD_API (LIVE) |
| Name Status | APPROVED |
| Account Status | APPROVED |
| Access Token | Generate permanent token via System User |
| API Version | v21.0 |
| Old WABA | `927271706367429` (has 7 approved HRMS templates, old phone IDs) |
| NOTE | **Templates need to be recreated on new WABA `774168882413528`** |
