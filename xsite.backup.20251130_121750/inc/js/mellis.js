(function ($) {
  ...
  // Force menu links to have bold font-weight
  $(document).ready(function() {
    $(".main-menu .menu-list > li > a, .stricky-header .menu-list > li > a").css("font-weight", "600");
    $(".main-menu .menu-list > li > ul > li > a, .main-menu .menu-list > li > ul > li > ul > li > a, .stricky-header .menu-list > li > ul > li > a, .stricky-header .menu-list > li > ul > li > ul > li > a").css("font-weight", "600");
  });
  ...
  if ($(".menu-list").length && $(".mobile-nav__container").length) {
    let navContent = document.querySelector(".menu-list").outerHTML;
  ...
  if ($(".mobile-nav__container .menu-list").length) {
    let dropdownAnchor = $(
      ".mobile-nav__container .menu-list .dropdown > a"
    );
