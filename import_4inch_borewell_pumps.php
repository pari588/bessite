 ...
 * Downloads images, converts to WebP, and creates database entries
 */
...
$products = array(
    ...
    array(
        'title' => '4 inch Water filled Borewell Submersible Pump 1.5 HP',
        'model' => '4W12BF1.5E',
        'kwhp' => '1.5 HP',
        'supplyPhase' => '1PH',
        'pumpType' => '4-Inch Water-Filled Borewell Submersible',
    ...
    array(
        ...
        'supplyPhase' => '1PH',
        'pumpType' => '4-Inch Water-Filled Borewell Submersible',
        'features' => '<p><strong>4W14BF1.5E - 4 inch Water-Filled Borewell Submersible Pump 2 HP</strong></p><ul><li>Power Rating: 2 HP / 1.5 KW</li><li>Pump Type: Water-Filled Submersible</li><li>Bore Size: 4 Inch</li><li>Single Phase Operation</li><li>Premium water-filled cooling system</li><li>High discharge capacity</li><li>Suitable for large bore wells</li><li>Enhanced motor protection</li><li>Professional grade construction</li></ul>',
        'image_url' => 'https://www.crompton.co.in/cdn/shop/files/4w-png.png',
        'image_name' => '4w14bf1-5e.webp'
    ),
    array(
        'title' => '4 inch Water filled Borewell Submersible Pump 2.5 HP',
        'model' => '4W14BU2EU',
        'kwhp' => '2.5 HP',
        'supplyPhase' => '1PH',
        'pumpType' => '4-Inch Water-Filled Borewell Submersible',
        'features' => '<p><strong>4W14BU2EU - 4 inch Water-Filled Borewell Submersible Pump 2.5 HP</strong></p><ul><li>Power Rating: 2.5 HP / 1.85 KW</li><li>Pump Type: Water-Filled Submersible</li><li>Bore Size: 4 Inch</li><li>Single Phase Operation</li><li>Maximum discharge performance</li><li>Superior water cooling efficiency</li><li>Heavy-duty construction</li><li>Ideal for commercial applications</li><li>Extended warranty coverage</li></ul>',
        'image_url' => 'https://www.crompton.co.in/cdn/shop/files/4w-png.png',
    ...
    array(
        ...
        'supplyPhase' => '1PH',
        'pumpType' => '4-Inch Oil-Filled Borewell Submersible',
        'features' => '<p><strong>4VO1.5/14-BUE(U4S) - 4 inch Oil-Filled Borewell Submersible Pump 1.5 HP BU</strong></p><ul><li>Power Rating: 1.5 HP / 1.1 KW</li><li>Pump Type: Oil-Filled Submersible</li><li>Bore Size: 4 Inch</li><li>Single Phase Operation</li><li>High discharge capacity</li><li>Robust motor design</li><li>Optimal cooling system</li><li>Professional grade construction</li><li>Suitable for commercial use</li></ul>',
        'image_url' => 'https://www.crompton.co.in/cdn/shop/files/artboard1_277b9f24-ac06-4c37-835f-ff388004917b.png',
...
foreach ($products as $product) {
    ...
    echo "Downloading: {$product['image_name']}... ";

    // Download image using curl
    $cmd = "curl -s -L '{$image_url}' -o '{$temp_path}/temp_image.png' 2>/dev/null";
    exec($cmd);

    if (file_exists("{$temp_path}/temp_image.png") && filesize("{$temp_path}/temp_image.png") > 100) {
        // Convert PNG to WebP
        $convert_cmd = "convert '{$temp_path}/temp_image.png' '{$local_image}' 2>/dev/null";
        exec($convert_cmd);
...
foreach ($products as $product) {
    ...
    if (!file_exists($local_image)) {
        echo "❌ {$product['title']}: Image not found at {$local_image}\n";
        $db_failed++;
        continue;
    }
...
generateAllThumbnails($upload_path);

echo "\n=== Final Results ===\n";
echo "✅ Downloaded/Converted Images: $downloaded\n";
echo "✅ Products Added: $added\n";
echo "❌ Download Failures: $failed\n";
echo "❌ Database Failures: $db_failed\n";

// Verify total 4-inch borewell pumps
$DB->vals = array(28, 1);
$DB->types = "ii";
...
function generateAllThumbnails($upload_path) {
    $sizes = array(235, 530);
    $images = glob($upload_path . '/*.webp');
    $thumb_count = 0;
    ...
    foreach ($images as $image_file) {
        ...
        // Skip old files
        if (strpos($filename, '4w') !== 0 && strpos($filename, '4vo') !== 0) {
            continue;
        }

        foreach ($sizes as $size) {
            $thumb_path = $upload_path . '/' . $size . '_' . $size . '_crop_100/' . $filename;
