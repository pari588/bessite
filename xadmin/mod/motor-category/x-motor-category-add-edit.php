...
$DB->sql = "SELECT categoryMID,categoryTitle,parentID FROM `" . $DB->pre . "motor_category` WHERE status= ? $whereS ORDER BY categoryTitle";
$arrCats = $DB->dbRows();
$strOpt = getTreeDD($arrCats, "categoryMID", "categoryTitle", "parentID", $D['parentID'] ?? "");
