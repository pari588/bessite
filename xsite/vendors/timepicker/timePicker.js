            ...
            function () {
                ...
                if (!jQuery('#ptTimeSelectCntr').length) {
                    jQuery("body").append(
                        ...
                        +    '                <button type="button" onclick="jQuery.ptTimeSelect.closeCntr();" '
                        ...
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default" '
                        +    '                                        style="display: block; width: 45%; float: left;">AM</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default" '
                        +    '                                        style="display: block; width: 45%; float: left;">PM</button>'
                        +    '                                <br style="clear: left;" /><div></div>'
                        +    '                            </div>'
                        +    '                            <div class="ptTimeSelectHrCntr">'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">1</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">2</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">3</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">4</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">5</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">6</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">7</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">8</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">9</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">10</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">11</button>'
                        +    '                                <button type="button" class="ptTimeSelectHr ui-state-default">12</button>'
                        +    '                                <br style="clear: left;" /><div></div>'
                        +    '                            </div>'
                        +    '                        </div>'
                        +    '                    </div>'
                        ...
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">00</button>'
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">05</button>'
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">10</button>'
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">15</button>'
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">20</button>'
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">25</button>'
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">30</button>'
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">35</button>'
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">40</button>'
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">45</button>'
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">50</button>'
                        +    '                                <button type="button" class="ptTimeSelectMin ui-state-default">55</button>'
                        +    '                                <br style="clear: left;" /><div></div>'
                        +    '                            </div>'
                        +    '                        </div>'
                        +    '                    </div>'
                        ...
                        +    '            <button type="button" onclick="jQuery.ptTimeSelect.setTime()"'
                        +    '                    onmouseover="jQuery(this).removeClass(\'ui-state-default\').addClass(\'ui-state-hover\');" '
                        +    '                        onmouseout="jQuery(this).removeClass(\'ui-state-hover\').addClass(\'ui-state-default\');"'
                        +    '                        class="ui-corner-all ui-state-default">'
                        +    '                SET'
