...
$arrApplicationDetails = array(
	...
	array("type" => "text", "name" => "requiredDischarge", "title" => "Required Discharge", "validate" => "", "attr" => "placeholder='LPM (Liters Per Minute)'"),
	...
	<div class="container">
		...
		<form name="pumpInquiryForm" class="pumpInquiryForm" id="pumpInquiryForm" action="" method="post" enctype="multipart/form-data" auto="false">
			...
			<div class="form-actions">
				<a href="#" class="fa-save button thm-btn" rel="pumpInquiryForm" role="button" onclick="return false;">Submit Inquiry</a>
