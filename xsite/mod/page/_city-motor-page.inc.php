<?php
/**
 * Shared renderer for Tier-1 city motor landing pages.
 * Each city template defines $cfg (unique local content) and calls renderCityMotorPage($cfg).
 * Uses shared /css/landing.css. Design: Trust & Authority. No pricing (Call-for-Price).
 */
if (!function_exists('renderCityMotorPage')) {
    function renderCityMotorPage($cfg)
    {
        // Decode-then-escape so config values may contain either "&" or "&amp;"
        // without double-encoding (idempotent).
...
<script type="application/ld+json">
{
    ...
    "@type": "WebPage",
    "name": <?php echo json_encode('Motors in ' . $cfg['city'] . ' - CG Crompton Industrial Motor Dealer & Supplier', JSON_UNESCAPED_UNICODE); ?>,
    ...
    <div class="container">
        <div class="page-header__inner">
            <ul class="thm-breadcrumb list-unstyled">
                ...
                <li><span>/</span></li>
                <li>Motors in <?php echo $e($cfg['city']); ?></li>
            </ul>
            <h2>Motors in <?php echo $e($cfg['city']); ?></h2>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-5">
                <div class="lp-hero__card">
                    ...
                    <div class="lp-card__map">
                        <iframe src="https://www.google.com/maps?q=<?php echo urlencode($cfg['map_q']); ?>&z=<?php echo $e($cfg['map_z']); ?>&output=embed" width="100%" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="Motor supply coverage across <?php echo $e($cfg['city']); ?>"></iframe>
                    </div>
                </div>
            </div>
        </div>
...
<section class="lp-products">
    <div class="container">
        <div class="section-title text-center">
            <h2 class="section-title__title">Electric Motors We Supply in <?php echo $e($cfg['city']); ?></h2>
...
<section class="lp-why-us">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h2>Why <?php echo $e($cfg['city']); ?> Industries Choose Bombay Engineering for Motors</h2>
...
<section class="lp-coverage">
    <div class="container">
        <div class="section-title text-center">
            ...
            <p class="section-title__text">We deliver CG &amp; Crompton motors, drives and spares across the region.</p>
        </div>
...
<section class="lp-cta" id="city-inquiry">
    <div class="container">
        <div class="lp-cta__inner">
            <h2 class="lp-cta__title">Request a Motor Quote for <?php echo $e($cfg['city']); ?></h2>
            <p class="lp-cta__text">Share your motor requirement &mdash; power rating, mounting, efficiency class and application &mdash; and our team will recommend the right CG Power / Crompton model and share a quotation.</p>
