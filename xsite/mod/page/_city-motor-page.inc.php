...
<script type="application/ld+json">
{
    ...
    "@type": "WebPage",
    "name": <?php echo json_encode('Motors in ' . $cfg['city'] . ' - CG Power Industrial Motor Dealer & Supplier', JSON_UNESCAPED_UNICODE); ?>,
...
<section class="lp-coverage">
    <div class="container">
        <div class="section-title text-center">
            ...
            <p class="section-title__text">We deliver CG &amp; CG Power motors, drives and spares across the region.</p>
        </div>
