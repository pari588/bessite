<?php
// Generate 530x530 thumbnails for DMB-CMB pump images

$sourceDir = __DIR__ . '/uploads/pump/';
$thumbDir = __DIR__ . '/uploads/pump/530_530_crop_100/';
...
echo "=== Generating 530x530 Thumbnails ===\n\n";
...
echo "=== Verification ===\n\n";
echo "Thumbnails in uploads/pump/530_530_crop_100/:\n";
